...
return array(
    'dompdf_module' => array(
         ...
         * *Please note the trailing slash.*
         */
        'font_directory' => __DIR__ . '/../../dompdffonts/fonts/',
         ...
         */
        'font_cache_directory' => __DIR__ . '/../../dompdffonts/cache/',
         ...
         */
        'chroot' => realpath(__DIR__ . '/../../vendor/dino/dompdf-module/vendor/dompdf/'),
         ...
         * @var string
         */
        'log_output_file' => __DIR__ . '/../../dompdffonts/log/',
