    ...
    public function __construct() {
        ...
        $this->add(
            ...
            'options'       => array(
	            ...
	            'hint'               => '2008.8.5',
	            'description'        => "Le numéro, unique, attribué par le musée propriétaire, et marqué sur l'objet a valeur juridique. Une fois porté à l'inventaire, ce numéro ne doit plus être modifié.",
	        ))
         );
                //Textarea
         $this->add(array(
        ...
        $this->add(//Date
        		array(
        				...
        				'options'       => array(
        						...
        						'description'       => "Il est rappelé que conformément à l'article 2 de l'arrêté du 25 mai 2004, l'inscription à l'inventaire d'un bien affecté aux collections d'un musée de France doit intervenir au plus tard le 31 décembre de l'année suivant l'année de l'acquisition.",
        				),
        		)
        );
